...
^sas^: définition des bornes alternatives. Si on séléctionne une strate avec if, on doit réouvrir la base enregistree avec ltable
     pour 
...
-------------------------
^webuse rat^
^quietly ltable t died, saving(lt)^
^use lt^
^qlt^
